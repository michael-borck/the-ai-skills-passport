> This content is from the AI Toolkit resource: Seven Essential Prompt Techniques, part of the AI Skills Passport for SoMM staff at Curtin University.

# Seven Essential Prompt Techniques
...
### Why It Works for HR
Many HR competencies require both knowledge (legislation, theory) and application (recognising situations where that knowledge applies). Students need more practice than traditional homework provides, but creating dozens of unique practice scenarios is time-prohibitive for lecturers. AI solves this.
...
**What Happens:**
Progressive difficulty builds confidence and competence. Students move from obvious cases to nuanced judgement calls.
...
Choose **one technique** from this guide and try it yourself. Pick the one that feels most immediately useful for a topic you're currently working with.

Copy one of the example prompts in your discipline's tab, adapt it to your specific content, and see what happens. Get comfortable with at least one of these techniques before exploring the more complex applications.
