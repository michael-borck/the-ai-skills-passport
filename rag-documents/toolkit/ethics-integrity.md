> This content is from the AI Toolkit resource: Ethics, Data Governance & Integrity, part of the AI Skills Passport for SoMM staff at Curtin University.
...
→ You assess **visible process and conversation quality**, not just a polished text.
...
## 5.4 Assess the Conversation, Not Just the Product

- Ask students to submit **full AI conversation transcripts** alongside their work, with brief annotations pointing to key moments where they steered or refined the output.
- This makes the thinking visible in the interaction pattern itself. AI can write convincing reflections, but a genuine iterative conversation is much harder to fake.
- Frame the expectation upfront: **"I'm looking for conversation, not delegation."**
...
- No real evidence of **genuine AI conversation** in a process-based task
