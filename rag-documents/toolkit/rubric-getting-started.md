> This content is from the AI Toolkit resource: AI-Integrated Assessment Rubric Suite: Getting Started, part of the AI Skills Passport for SoMM staff at Curtin University.

# AI-Integrated Assessment Rubric Suite: Getting Started
...
- Documenting AI use (via conversation transcripts) is a valued skill
...
**Why?** The quality of the AI conversation, whether students challenged, refined, and steered the interaction, is where they develop judgement. Accountability ensures integrity. Note: written reflections are easily AI-generated, but a genuine conversation transcript is much harder to fake.
...
- Conversation transcripts expose when students are genuinely engaging vs. just delegating

If you see undeclared AI use, the rubric criteria (especially Conversation Quality) make it visible.
...
- How AI conversation transcripts should be submitted
- Academic integrity expectations (with transparency as the core principle)

### During Marking
- Look for evidence in student conversation transcripts: Can you see their thinking?
- Look for conversation, not delegation: did they challenge, refine, and follow up?
