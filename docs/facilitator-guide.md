...
### Logistics
- [ ] Book room with screen/projector
- [ ] Confirm participants have laptops (or arrange loan devices)
- [ ] Ensure Wi-Fi access (or have offline backups)
- [ ] Send calendar invite with any pre-work

### Preparation
- [ ] Review the relevant SPA thoroughly
- [ ] Test all interactive elements work
- [ ] Prepare 2-3 examples from your own context
- [ ] Have backup discussion questions ready

### Materials Needed
- Printed handout (optional): Key frameworks on one page
- Sticky notes and markers (for group activities)
- Timer/phone for activity pacing
...
- Each group identifies 2-3 specific applications
...
### 2. What Would You Do? (Ethics & Dilemmas)
**Opening hook:** Present a dilemma, take a quick poll
**Core activity:** Work through branching scenarios in pairs
...
### 4. AI-Proof Your Assessments (Assessment Design)
**Opening hook:** AI attempts a real assessment live
**Core activity:** Participants stress-test their own assessments
**Discussion:** Which pathway fits your context?

### 5. Teaching WITH AI (Co-Creation & Integration)
...
- [ ] Ensure participants know how to mark completion
- [ ] Share link to AI Toolkit for reference
- [ ] Follow up with AI in 5 enrollment option
- [ ] Note what worked/didn't for next time
- [ ] Collect informal feedback (what was most useful?)
...
At end of workshop:
1. Direct participants to the relevant Experience SPA
2. Click "Mark as Complete" button
3. Or use My Passport to verify their progress

If server isn't running, completion saves to browser localStorage.

---

## Contact

Questions about facilitation: **Michael Borck**, AI Facilitator, SoMM
